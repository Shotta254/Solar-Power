            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('inventory-items.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="brand" id="brand" class="w-full border rounded px-3 py-2" required>
                    </div>

                    <div class="mb-4">
                        <label class="block text-gray-700 dark:text-gray-200">Model</label>
                        <input type="text" name="model" id="model" class="w-full border rounded px-3 py-2">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="quantity" class="w-full border rounded px-3 py-2" min="0" max="99999" required>
                    </div>

                    <div class="mb-4">
                        <label class="block text-gray-700 dark:text-gray-200">Price</label>
                        <input type="number" step="0.01" name="price" class="w-full border rounded px-3 py-2" min="0" max="99999" required>
                    </div>
